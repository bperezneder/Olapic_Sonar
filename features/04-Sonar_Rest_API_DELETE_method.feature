Feature: Sonar Rest Api, DELETE method
    ...
    Scenario: Deletting Sonar Object, Invalid PROVIDER_NAME
        ...
        Then I expect the response status code to be 404
        Then the response is a valid JSON
        Then the response has a "meta/error" property matching "PlaceNotDeleted"
        Then the response has a "meta/error_message" property matching "Unknown provider with name: xxxxxxxx"
